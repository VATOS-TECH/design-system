...
2. 해당 산출물 유형의 제작 가이드
3. 공통 디자인 기준
4. 사용자가 제공한 이미지, 아이콘 및 자료
5. 공식 브랜드 자산
6. 승인된 컴포넌트 참고자료
7. 레이아웃 참고자료
8. 편집 가능한 문서 템플릿
9. 디자인 시스템이 적용된 완성 예시
10. 저장소 운영 안내
...
|---|---|---|---|
| PPT / Presentation | `ppt-production-rules` | `common-design-rules`, `ppt-layout-references`, `brand-assets` | 제목 영역과 본문 영역을 분리하고, 콘텐츠 그룹을 중앙 안전 영역 안에서 가로·세로 균형 있게 배치한다. |
